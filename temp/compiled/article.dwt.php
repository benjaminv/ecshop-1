...
?>
            ...
            <div class="side-goods">
                ...
                <div class="bd">
                    <?php $_from = $this->_var['related_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'related_goods_0_97253600_1575335264');if (count($_from)):
    foreach ($_from AS $this->_var['related_goods_0_97253600_1575335264']):
?>
                    <div class="item">
                        <div class="p-img"><a href="<?php echo $this->_var['related_goods_0_97253600_1575335264']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['related_goods_0_97253600_1575335264']['goods_img']; ?>" alt=""></a></div>
                        <div class="p-name"><a href="<?php echo $this->_var['related_goods_0_97253600_1575335264']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['related_goods_0_97253600_1575335264']['goods_name']); ?>" target="_blank"><?php echo $this->_var['related_goods_0_97253600_1575335264']['goods_name']; ?></a></div>
                        <div class="p-price"><?php echo $this->_var['related_goods_0_97253600_1575335264']['shop_price']; ?></div>
                    </div>
                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </div>
            </div>
