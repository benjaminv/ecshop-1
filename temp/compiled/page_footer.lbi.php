    ...
    <div class="footer-new-bot">
    	<div class="w w1200">
            ...
            <p class="copyright_links">
                <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_59143900_1575445989');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_59143900_1575445989']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
                <a href="<?php echo $this->_var['nav_0_59143900_1575445989']['url']; ?>"<?php if ($this->_var['nav_0_59143900_1575445989']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_59143900_1575445989']['name']; ?></a>
...
?>
            ...
            <p><span>©&nbsp;2015-2019&nbsp;dsc.suanmy.cn&nbsp;版权所有&nbsp;&nbsp;</span><span><?php echo $this->_var['lang']['icp_number']; ?>:</span><a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo $this->_var['icp_number']; ?></a>&nbsp;POWERED <a href="http://dsc.suanmy.cn/" target="_blank">EC商城</a>2.0</p>
            <?php endif; ?>
