...
?>
	...
	<?php $_from = $this->_var['user_lang']['passport_js']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'lang_0_34635700_1575523763');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['lang_0_34635700_1575523763']):
?>
	var <?php echo $this->_var['k']; ?>="<?php echo $this->_var['lang_0_34635700_1575523763']; ?>";
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		/* *
		 * 会员登录
		*/ 
