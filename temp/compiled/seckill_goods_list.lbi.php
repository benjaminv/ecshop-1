...
<div class="seckill-channel" id="h-seckill">
	...
	<div class="box-bd clearfix">
    	<?php endif; ?>
		<ul>
			<?php $_from = $this->_var['seckill_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_20489200_1574930285');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_20489200_1574930285']):
?>
            <?php if ($this->_var['temp'] == 'backup_festival_1'): ?>
            <li class="opacity_img">
                <div class="p-img"><a href="<?php echo $this->_var['goods_0_20489200_1574930285']['list_url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods_0_20489200_1574930285']['goods_thumb']; ?>"></a></div>
                <div class="p-name"><a href="<?php echo $this->_var['goods_0_20489200_1574930285']['list_url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods_0_20489200_1574930285']['goods_name']); ?>"><?php echo $this->_var['goods_0_20489200_1574930285']['goods_name']; ?></a></div>
                <div class="p-price">
                    <span class="shop-price"><?php echo $this->_var['goods_0_20489200_1574930285']['sec_price']; ?></span>
                    <span class="original-price"><?php echo $this->_var['goods_0_20489200_1574930285']['market_price']; ?></span>
                </div>
            </li>
            <?php else: ?>
			<li class="opacity_img">
				<div class="p-img"><a href="<?php echo $this->_var['goods_0_20489200_1574930285']['list_url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods_0_20489200_1574930285']['goods_thumb']; ?>" class="img-lazyload"></a></div>
				<div class="p-name"><a href="<?php echo $this->_var['goods_0_20489200_1574930285']['list_url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods_0_20489200_1574930285']['goods_name']); ?>"><?php echo $this->_var['goods_0_20489200_1574930285']['goods_name']; ?></a></div>
				<div class="p-over">
					<div class="p-info">
						<div class="p-price">
					...
					<a href="<?php echo $this->_var['goods_0_20489200_1574930285']['url']; ?>"  target="_blank"><?php echo $this->_var['lang']['begin_minute']; ?></a>
					<?php else: ?>
					<?php if ($this->_var['goods_0_20489200_1574930285']['sec_num'] <= 0): ?>
					<a href="javascript:;"><?php echo $this->_var['lang']['has_been_snatched']; ?></a>
					<?php else: ?>
					<a href="<?php echo $this->_var['goods_0_20489200_1574930285']['url']; ?>"  target="_blank"><?php echo $this->_var['lang']['immediate_rush_buy']; ?></a>
					<?php endif; ?>
					<?php endif; ?>
					</div>
				</div>
