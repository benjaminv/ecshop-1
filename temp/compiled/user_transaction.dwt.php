...
?>
                                ...
                                <div class="imitate_select w90">
                                    ...
                                    <ul>
                                        <?php $_from = $this->_var['select_date']['day']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'data_0_25018300_1575450618');if (count($_from)):
    foreach ($_from AS $this->_var['data_0_25018300_1575450618']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['data_0_25018300_1575450618']; ?>"><?php echo $this->_var['data_0_25018300_1575450618']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
                            ...
                            <div class="value">
                                <div class="imitate_select w200">
                                    ...
                                    <ul>
                                        ...
                                        <?php $_from = $this->_var['passwd_questions']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'data_0_25018300_1575450618');if (count($_from)):
    foreach ($_from AS $this->_var['data_0_25018300_1575450618']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['data_0_25018300_1575450618']; ?>"><?php echo $this->_var['data_0_25018300_1575450618']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
                            ...
                            <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                                ...
                                <dd ectype="layer">
                                    ...
                                    <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_25818300_1575450618');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_25818300_1575450618']):
?>
                                    <div class="option" data-value="<?php echo $this->_var['province_0_25818300_1575450618']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_25818300_1575450618']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_25818300_1575450618']['region_name']; ?></div>
                                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                </dd>
                            </dl>
                            <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
...
?>
                                        ...
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                            ...
                                            <dd ectype="layer">
                                                <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                                <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_26018400_1575450618');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_26018400_1575450618']):
?>
                                                <div class="option" data-value="<?php echo $this->_var['province_0_26018400_1575450618']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_26018400_1575450618']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_26018400_1575450618']['region_name']; ?></div>
                                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                            </dd>
                                        </dl>
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
								...
								<dl class="mod-select mod-select-small" ectype="smartdropdown">
									...
									<dd ectype="layer">
										<div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
										<?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_26118400_1575450618');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_26118400_1575450618']):
?>
										<div class="option" data-value="<?php echo $this->_var['province_0_26118400_1575450618']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_26118400_1575450618']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_26118400_1575450618']['region_name']; ?></div>
										<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
									</dd>
								</dl>
								<dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
                                ...
                                <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                                    ...
                                    <dd ectype="layer">
                                        <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_27118400_1575450618');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_27118400_1575450618']):
?>
                                        <div class="option" data-value="<?php echo $this->_var['province_0_27118400_1575450618']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_27118400_1575450618']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_27118400_1575450618']['region_name']; ?></div>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </dd>
                                </dl>
                                <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
...
?>
                                ...
                                <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                    ...
                                    <dd ectype="layer">
                                        <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_27218400_1575450618');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_27218400_1575450618']):
?>
                                        <div class="option" data-value="<?php echo $this->_var['province_0_27218400_1575450618']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_27218400_1575450618']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_27218400_1575450618']['region_name']; ?></div>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </dd>
                                </dl>
                                <dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
                                        ...
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                            ...
                                            <dd ectype="layer">
                                                <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                                <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_27418400_1575450618');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_27418400_1575450618']):
?>
                                                <div class="option" data-value="<?php echo $this->_var['province_0_27418400_1575450618']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_27418400_1575450618']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_27418400_1575450618']['region_name']; ?></div>
                                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                            </dd>
                                        </dl>
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
