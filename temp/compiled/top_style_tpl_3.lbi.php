...
?>
    ...
    <div class="catetop-lift lift-hide" ectype="lift">
    	<div class="lift-list" ectype="liftList">
        	...
        	<?php $_from = $this->_var['categories_child']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_64450500_1574930068');$this->_foreach['child'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['child']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_64450500_1574930068']):
        $this->_foreach['child']['iteration']++;
?>
            <div class="catetop-lift-item lift-floor-item" ectype="liftItem"><span><?php echo $this->_var['cat_0_64450500_1574930068']['name']; ?></span></div>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
