...
<div class="nav dsc-zoom" ectype="dscNav">
	...
	<div class="crumbs-nav-main clearfix">
			...
			<i class="iconfont icon-right"></i>		</div>
						<span class="cn-goodsName">aaaaaa</span>
			</div>
</div>
        </div>
    </div>
...
<div class="preview" if="preview">
	<div class="gallery_wrap">
        <ul>
                        <li ectype="img">
                <a href="images/201912/goods_img/0_P_1575243908339.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: img-hover; selectors-change: mouseover; zoom-distance: 10;zoom-width: 400; zoom-height: 474;">
                    <img src="images/201912/goods_img/0_P_1575243908339.jpg" id="J_prodImg" alt="aaaaaa">
                </a>
            </li>
        </ul>
    </div>
	<div class="spec-list">
		...
		<div class="spec-items">
			<ul>
                                ...
                                <li data-type="img">
					<a href="images/201912/goods_img/0_P_1575243908339.jpg" rel="zoom-id: Zoomer" rev="images/201912/goods_img/0_P_1575243908339.jpg" class="img-hover">
						<img src="images/201912/thumb_img/0_thumb_P_1575243908152.jpg" alt="aaaaaa" width="58" height="58" />
					</a>
				</li>
        ...
        <div class="short-share-r bar_code hide">条形条码：<em id="bar_code"></em></div>        <div class="left-btn">
            <div class="duibi">
                <a href="javascript:void(0);" id="compareLink">
                    <input type="checkbox" name="" class="ui-checkbox" id="2" onClick="Compare.add(this, 2,'aaaaaa','0', 'images/201912/thumb_img/0_thumb_G_1575243908111.jpg', '321', '<em>¥</em>385.20')">
                    <label for="2" class="ui-label">对比</label>
                </a>
            </div>
            <a href="javascript:void(0);" class="collection choose-btn-coll" data-dialog="goods_collect_dialog" data-divid="goods_collect" data-url="user.php?act=collect" data-goodsid="2" data-type="goods"><i class="iconfont choose-btn-icon icon-collection" id="collection_iconfont"></i><em>收藏 (<span id="collect_count"></span>)</em></a>
...
function get_collection(){
	Ajax.call('ajax_dialog.php', 'act=goods_collection&goods_id=' + 2, goodsCollectionResponse, 'GET', 'JSON');
}
function goodsCollectionResponse(res){
		...
		$("#collection_iconfont").removeClass('icon-collection-alt');
                ...
                <div class="product-wrap">
                    <form action="javascript:addToCart(2)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
                		<div class="name">aaaaaa</div>
                                                <div class="newp">safdsa</div>
                                                                        <div class="summary">
                                ...
                                <div class="s-p-w-wrap">
                                    <div class="summary-item si-shop-price">
                                        ...
                                        <div class="si-warp">
                                            ...
                                            <span class="price-notify" data-userid="0" data-goodsid="2" ectype="priceNotify">降价通知</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="qrcode-wrap">
                                            ...
                                            <div class="qrcode_pop">
                                                <div class="mobile-qrcode"><img src="images/weixin_img/weixin_code_2.png" alt="商品二维码" title="" width="175"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="si-warp">
                                                                                        <a class="J-open-tb" href="#none" data-goodsid="2">
                            ...
                            <div class="choose-btns ml60 clearfix">
                                                                                                                                                                                                        <a href="javascript:bool=0;addToCart(2)" data-type="0" class="btn-buynow" ectype="btn-buynow">立即购买</a>
                                                                                                    <a href="javascript:bool=0;addToCartShowDiv(2)" class="btn-append" ectype="btn-append"><i class="iconfont icon-carts"></i>加入购物车</a>
                        ...
                        <input type="hidden" value="2" id="good_id" name="good_id" />
	...
	<div class="mt">
		<h3>WEBSC</h3>
					<a id="IM" onclick="openWin(this)" href="javascript:;" ru_id="0" goods_id="2" class="s-a-kefu"><i class="icon i-kefu"></i></a>
			</div>
	<div class="mc">
		<div class="mc-warp">
			<div class="g-s-brand">
														<a href="brand.php?id=2" target="_blank"><img src="data/brandlogo/1575245401107871989.jpg" /></a>
												</div>
		</div>
							</div>
</div>
                                	...
                                	<div class="tb-popsku">
                                        ...
                                        <div class="tb-popsku-content">
                                            ...
                                            <div class="tb-list">
                                                ...
                                                <div class="tb-value">
													<a href="javascript:bool=0;addToCartShowDiv(2)" class="cz-btn cz-btn-true" ectype="btn-append">确定</a>
                    ...
                    <div class="gm-floors" ectype="gm-floors">
                        <div class="gm-f-item gm-f-details" ectype="gm-item">
                            ...
                            <div class="goods-para-list">
                                <dl class="goods-para">
                                    <dd class="column"><span>商品名称：aaaaaa</span></dd>
                                    <dd class="column"><span>商品编号：123</span></dd>
                                    <dd class="column"><span>店铺：<a href="" title="WEBSC" target="_blank">WEBSC</a></span></dd>
                                                                        <dd class="column"><span>重量：0克</span></dd>
                                                                                                            <dd class="column"><span>上架时间：2019-12-02 15:46:37</span></dd>
                                                                    </dl>
                                                                                                                            </div>
                            <p>213213212</p>                        </div>
                            ...
                            <div class="gm-title">
                                <h3>评论晒单</h3>
                                554fcae493e564ee0dc75bdf2ebf94cagoods_comment_title|a:2:{s:4:"name";s:19:"goods_comment_title";s:8:"goods_id";s:1:"2";}554fcae493e564ee0dc75bdf2ebf94ca                            </div>
                            <div class="gm-warp">
...
<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:2;}554fcae493e564ee0dc75bdf2ebf94ca</div>                                </div>
                            </div>
                        </div>
                        <div class="gm-f-item gm-f-tiezi" ectype="gm-item">
                            554fcae493e564ee0dc75bdf2ebf94cagoods_discuss_title|a:2:{s:4:"name";s:19:"goods_discuss_title";s:8:"goods_id";s:1:"2";}554fcae493e564ee0dc75bdf2ebf94ca                            <div class="table" id='discuss_list_ECS_COMMENT'></div>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
...
<script type="text/javascript" src="js/warehouse.js"></script><script type="text/javascript" src="js/warehouse_area.js"></script>
			...
			if(res.err_no == 2){
				...
				if($("#isHas_warehouse_num").length > 0){
					if((res.attr_number > 0) && (res.attr_number > 0 || res.original_spec_price == res.original_shop_price) && (1 != 0 || is_shipping == 1)){
						$("a[ectype='btn-append']").attr('href','javascript:addToCartShowDiv(2)').removeClass('btn_disabled');
						$("a[ectype='btn-buynow']").attr('href','javascript:addToCart(2)').removeClass('btn_disabled');
						...
						$("a[ectype='byStages']").addClass('btn_disabled');
								...
								if(1 != 0 || is_shipping == 1){
									...
									$('.choose-btns').append('<a id="quehuo" class="btn-buynow" href="javascript:addToCart(2);">暂时缺货</a>');
								}
							}
											}
					if(res.store_type == 1){
    ...
    554fcae493e564ee0dc75bdf2ebf94cagoods_delivery_area_js|a:2:{s:4:"name";s:22:"goods_delivery_area_js";s:4:"area";a:11:{s:9:"region_id";s:1:"2";s:11:"province_id";s:2:"23";s:7:"city_id";s:3:"301";s:11:"district_id";s:4:"2487";s:9:"street_id";s:1:"0";s:11:"street_list";s:1:"0";s:8:"goods_id";i:2;s:7:"user_id";i:0;s:7:"area_id";s:2:"22";s:9:"area_city";s:3:"545";s:11:"merchant_id";s:1:"0";}}554fcae493e564ee0dc75bdf2ebf94ca</body>
</html>
